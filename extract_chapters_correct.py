#!/usr/bin/env python3
"""Extract chapters from 法医病理司法鉴定实务 into separate files - correct version."""
...
def cn_to_arabic(cn_str):
    ...
    # Remove "第" prefix
    num_part = cn_str[1:]  # e.g., "十一" from "第十一章"
...
for idx in range(len(chapters)):
    ...
    chapter_num = cn_to_arabic(chapter_name)  # Extract number part and convert
