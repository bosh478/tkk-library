...
《被盗财物价格认定规则（试行）》第十一条规定，被盗财物价格认定常用方法有市场法、成本法、专家咨询法等。根据价格认定目的，被盗财物类别、状态、价格类型、可以采集的数据和信息资料情况、工作时限等因素，选择一种或几种价格认定方法。采用多种认定方法时，应综合考虑不同方法的测算思路和参数来源，分析每种方法对应结果的市场合理性，最终确定价格认定结论。该文件第十四条规定，被盗财物属性特殊、专业性强
