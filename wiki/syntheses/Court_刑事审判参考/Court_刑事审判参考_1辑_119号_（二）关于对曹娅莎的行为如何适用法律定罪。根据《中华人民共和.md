---
title: （二）关于对曹娅莎的行为如何适用法律定罪。根据《中华人民共和国刑法》第一百九十四条第一款票据诈骗罪的规定，票据诈骗罪是指利用汇票、本票、支票进行诈骗的行为。该条第二款规定的金融凭证诈骗罪，是指使用伪造、变造的委托收款凭证、汇款凭证、银行存单等其他银行结算凭证的行为。犯该罪的，依照前款票据诈骗罪的规定处罚。构成此款犯罪行为的条件，包括：
type: synthesis
created: 2026-05-17
updated: 2026-05-17
tags: [刑事审判参考, 第1辑, 诈骗]
