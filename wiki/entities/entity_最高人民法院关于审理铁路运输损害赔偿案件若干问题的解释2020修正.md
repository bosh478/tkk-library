...
type: entity
created: 2026-05-03
title: 最高人民法院关于审理铁路运输损害赔偿案件若干问题的解释2020修正
updated: 2026-05-03
tags: [待分类]
---
...
六 、保险补偿制度的适用
《铁路货物运输实行保险与负责运输相结合的补偿制度的规定（试行）》（简称保险补偿制度），适用于1991年５月１日铁路法实施以前已投保货物运输险的案件。铁路法实施后投保货物运输险的案件，适用铁路法第十七条第一款的规定，保险补偿制度中有关保险补偿的规定不再适用。
七 、逾期交付的责任
