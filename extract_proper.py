#!/usr/bin/env python3
"""Extract chapters from 法医病理司法鉴定实务 - PROPER VERSION."""
...
def cn_to_num(s):
    """Convert Chinese number string to integer - PROPER VERSION."""
    ...
    while i < n:
        c = s[i]
        if c in cn_map and i + 1 < n and s[i + 1] == '十':
            # Digit followed by 十, like 二十一 -> 21, 十一 -> 11
