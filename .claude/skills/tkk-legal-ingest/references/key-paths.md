...
| 版本 | 日期 | 核心变化 |
|------|------|----------|
| v52 | 2026-05-06 | **Zettelkasten 化重构**：知识节点原子化提取、行号脚注机制、知识关联网络、309个文件 related 字段迁移为 wikilink（出链+273%）、新增 verify_wikilinks.py/network_density.py |
| v51 | 2026-05-06 | **修复：Clippings自动检测触发可靠性**，增加多重验证+交叉检测；**新增：可跳过文件类型定义**，明确跳过标准+log记录要求；**强化：Phase 2 门控阈值降至300字符** |
